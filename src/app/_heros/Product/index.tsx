...
export const ProductHero: React.FC<{
  ...
  const isAvailableSoon = categories?.some(category => 
    typeof category !== 'string' && category.title.toLowerCase() === 'available soon'
  )
  return (
    <Gutter className={classes.productHero}>
      ...
      <div className={classes.details}>
        ...
        <div className={classes.categoryWrapper}>
          ...
          {isAvailableSoon ? 'Available Soon' : 'Available'}            </p>
        </div>
